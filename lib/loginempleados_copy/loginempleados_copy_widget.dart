...
class LoginempleadosCopyWidget extends StatefulWidget {
  const LoginempleadosCopyWidget({Key key}) : super(key: key);

  @override
  _LoginempleadosCopyWidgetState createState() =>
      _LoginempleadosCopyWidgetState();
}

class _LoginempleadosCopyWidgetState extends State<LoginempleadosCopyWidget> {
